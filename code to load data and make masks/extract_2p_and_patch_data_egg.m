...
%recording.abf.middle_of_trig = trig(1:1700*12)';

%trig = [trig(1:((1177)*11)), trig((end-2352-11*1480-11*2000+1):(end-2352))];


%trig = [trig(1:(542*11)),  trig((end-500*11+1):(end))];
%trig = [trig(1:1183*13) ];

%trig = [trig(1:(1500*11*5+899*11)), trig((end-(1500*11)+1):end)];


%trig = [trig(1:(4774*11)), trig(52526:(52526+1150*11-1)),   trig(65183:(65183+1187*11-1)),   trig(78241:(78241+1143*11-1)),   trig(90825:(90825+1143*11-1)),   trig(103405:(103405+464*11-1)),   trig(108520:(108520+2023*11-1)),   trig(130782:(130782+1016*11-1)),   trig(141959:(141959+1100*11-1)),   trig(154070:(154070+1455*11-1))];
%trig = [trig(1:(2623*11)), trig(28857:(28857+5000*11-1)),   trig(83857:(83857+1257*11-1)),   trig(97694:(97694+225*11-1)),   trig(100174:(100174+1767*11-1)),   trig(119622:(119622+5000*11-1)),   trig(174621:(174621+5000*11-1))];

% trig = [trig(1:((5258*11)),trig((end-10199*11+1):end) ];
%
% trig = [trig(1:((15000+4579)*11)) ];
