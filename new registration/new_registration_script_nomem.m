...
function M_final = new_registration_script_nomem(name,path)
...
options=NoRMCorreSetParms('d1             ',size(Y,1),...          %% dataset info % number of rows
    ...
    'grid_size      ',[16,16,16],...             %% patches % size of non-overlapping regions (default: [d1,d2,d3])
    'overlap_pre    ',[32,32,16],...              % size of overlapping region (default: [32,32,16])
    'min_patch_size ',[32,32,16],...              % minimum size of patch (default: [32,32,16])
    'min_diff       ',[16,16,5],...               % minimum difference between patches (default: [16,16,5])
    ...
    'overlap_post   ',[32,32,16],...              % size of overlapping region after upsampling (default: [32,32,16])
    'max_shift      ',[25,25,5],...               % maximum rigid shift in each direction (default: [15,15,5])
