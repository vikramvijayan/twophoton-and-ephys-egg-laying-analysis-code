...
function [rec_list, ROI_list, fly_ID, cell_ID] = import_ROI_names_SS53469_7f_gtacr1565_no2filter(ROIsSS53469, whatdoyouwant)

%function [recording] = make_small_recording_group()

%  SS53469 descending neurons with gtacr1 and Gcamp7f
recording_list = {'2019_11_26_0001.mat','2019_11_26_0002.mat','2019_11_26_0003.mat','2019_11_26_0004.mat','2019_11_26_0005.mat','2019_09_04_0004.mat','2019_09_04_0005.mat','2019_09_04_0006.mat'};
