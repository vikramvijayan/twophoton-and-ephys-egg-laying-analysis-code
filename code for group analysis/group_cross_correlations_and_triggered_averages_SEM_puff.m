function [corr_structure,pulse_structure] = group_cross_correlations_and_triggered_averages_SEM_puff(recordings_list, ROI_num, min_power, max_power, filter_out_pulse, backsub, pulse_duration_min,pulse_duration_max)
