function [transition_structure, transition_structure_notperfly] = group_plot_signal_at_transitions_moredetails(recordings_list, ROI_num, filter_out_chrimson_data, filter_out_egg_times, backsub)
% ROI_num = -1 use patch
