function [corr_structure,egg_structure] = group_cross_correlations_SEM(recordings_list, ROI_num, filter_out_chrimson_data, filter_chrimson_eggs, filter_out_egg_times, backsub)
...
for rec_index = 1:1:length(recordings_list)
    ...
    data_around_egg_vel = [data_around_egg_vel; data_to_average_interp];
      ...
      [time_base_to_return, data_to_average_interp]  = average_around_event(wheelvelocity_noave,movtime,all_eggt, [-240:.1:240]);
...
corr_to_prob = [corr_structure(1:end).corr_to_prob];

figure; hold on; %title([recording.abfname ',ROI ' num2str(ROI_num)],'Interpreter','none');
set(gca,'TickDir','out');
patch_errorbar(nanmean(corr_to_prob')', nansem(corr_to_prob')', time_base_corr_to_body', [.5 .5 .5])
%plot(time_base_corr_to_body,corr_to_body_y,'color',[.75,.75,.75]);
plot(time_base_corr_to_body,nanmean(corr_to_prob,2),'-k');
ylabel('corr coeff');
...
corr_to_prob_y = [corr_structure(1:end).corr_to_prob_y];

figure; hold on; %title([recording.abfname ',ROI ' num2str(ROI_num)],'Interpreter','none');
set(gca,'TickDir','out');
patch_errorbar(nanmean(corr_to_prob_y')', nansem(corr_to_prob_y')', time_base_corr_to_body', [.5 .5 .5])
%plot(time_base_corr_to_body,corr_to_body_y,'color',[.75,.75,.75]);
plot(time_base_corr_to_body,nanmean(corr_to_prob_y,2),'-k');
ylabel('corr coeff');
...
corr_to_prob_x = [corr_structure(1:end).corr_to_prob_x];

figure; hold on; %title([recording.abfname ',ROI ' num2str(ROI_num)],'Interpreter','none');
set(gca,'TickDir','out');
patch_errorbar(nanmean(corr_to_prob_x')', nansem(corr_to_prob_x')', time_base_corr_to_body', [.5 .5 .5])
%plot(time_base_corr_to_body,corr_to_body_y,'color',[.75,.75,.75]);
plot(time_base_corr_to_body,nanmean(corr_to_prob_x,2),'-k');
ylabel('corr coeff');
...
figure; hold on; %title([recording.abfname ',ROI ' num2str(ROI_num)],'Interpreter','none');
set(gca,'TickDir','out');
patch_errorbar(nanmean(corr_to_egg')', nansem(corr_to_egg')', time_base_corr_to_egg', [.5 .5 .5])
%plot(time_base_corr_to_egg,corr_to_egg,'color',[.75,.75,.75]);
...
figure; hold on; %title([recording.abfname ',ROI ' num2str(ROI_num)],'Interpreter','none');
set(gca,'TickDir','out');
patch_errorbar(nanmean(corr_to_plainegg')', nansem(corr_to_plainegg')', time_base_corr_to_plainegg', [.5 .5 .5])
%plot(time_base_corr_to_plainegg,corr_to_plainegg,'color',[.75,.75,.75]);
...
figure; hold on; %title([recording.abfname ',ROI ' num2str(ROI_num)],'Interpreter','none');
set(gca,'TickDir','out');
patch_errorbar(nanmean(corr_to_sucroseegg')', nansem(corr_to_sucroseegg')', time_base_corr_to_sucroseegg', [.5 .5 .5])
%plot(time_base_corr_to_sucroseegg,corr_to_sucroseegg,'color',[.75,.75,.75]);
...
if(~isempty(data_around_egg_body))
    if(ppp > 1)
        ...
        patch_errorbar(nanmean(data_around_egg_vel')', nansem(data_around_egg_vel')', time_base_egg', [.5 .5 .5])
    end
    %plot(time_base_egg,data_around_egg_vel,'color',[.75,.75,.75]);
...
if(~isempty(data_around_egg_body))
    if(ppp > 1)
        ...
        patch_errorbar(nanmean(abs(data_around_egg_vel)')', nansem(abs(data_around_egg_vel)')', time_base_egg', [.5 .5 .5])
    end
    %plot(time_base_egg,data_around_egg_vel,'color',[.75,.75,.75]);
    plot(time_base_egg,nanmean(abs(data_around_egg_vel),2),'-k');
end
ylabel('abs(vel), mm/sec (smth 1s)');
xlabel('time (sec)'); %since peak is neg, patch comes first. however...
axis manual;
line('Xdata',[0,0],'YData',[-1000,1000],'Color','c');
...
if(~isempty(data_around_egg_body))
    if(ppp > 1)
        ...
        patch_errorbar(nanmean((data_around_egg_speed_2hz_hold)')', nansem((data_around_egg_speed_2hz_hold)')', time_base_egg', [.5 .5 .5])
    end
    %plot(time_base_egg,data_around_egg_vel,'color',[.75,.75,.75]);
    plot(time_base_egg,nanmean(data_around_egg_speed_2hz_hold,2),'-k');
end
ylabel('speed 2hz hold, mm/sec');
xlabel('time (sec)'); %since peak is neg, patch comes first. however...
axis manual;
line('Xdata',[0,0],'YData',[-1000,1000],'Color','c');
...
if(~isempty(data_around_egg_body))
    if(ppp > 1)
        ...
        patch_errorbar(nanmean(data_around_egg_prob_x')', nansem(data_around_egg_prob_x')', time_base_egg', [.5 .5 .5])
    end
    % plot(time_base_egg,data_around_egg_body,'color',[.75,.75,.75]);
    plot(time_base_egg,nanmean(data_around_egg_prob_x,2),'-k');
end
ylabel('proboscis x length');
xlabel('time (sec)'); %since peak is neg, patch comes first. however...
axis manual;
line('Xdata',[0,0],'YData',[-1000,1000],'Color','c');
...
if(~isempty(data_around_egg_body))
    if(ppp > 1)
        ...
        patch_errorbar(nanmean(data_around_egg_prob_y')', nansem(data_around_egg_prob_y')', time_base_egg', [.5 .5 .5])
    end
    % plot(time_base_egg,data_around_egg_body,'color',[.75,.75,.75]);
    plot(time_base_egg,nanmean(data_around_egg_prob_y,2),'-k');
end
ylabel('proboscis y length');
xlabel('time (sec)'); %since peak is neg, patch comes first. however...
axis manual;
line('Xdata',[0,0],'YData',[-1000,1000],'Color','c');
...
if(~isempty(data_around_egg_body))
    if(ppp > 1)
        ...
        patch_errorbar(nanmean(data_around_egg_body')', nansem(data_around_egg_body')', time_base_egg', [.5 .5 .5])
    end
    % plot(time_base_egg,data_around_egg_body,'color',[.75,.75,.75]);
...
if(~isempty(data_around_egg_body))
    if(ppp > 1)
        ...
        patch_errorbar(nanmean(data_around_egg_body_y')', nansem(data_around_egg_body_y')', time_base_egg', [.5 .5 .5])
    end
...
if(~isempty(data_around_egg_body))
    if(ppp > 1)
        ...
        patch_errorbar(nanmean(data_around_egg_path')', nansem(data_around_egg_path')', time_base_egg', [.5 .5 .5])
    end
...
if(~isempty(data_around_egg_body))
    if(ppp > 1)
        ...
        patch_errorbar(nanmean(data_around_egg_body_only')', nansem(data_around_egg_body_only')', time_base_egg', [.5 .5 .5])
    end
...
if(~isempty(data_around_egg_body))
    if(ppp > 1)
        ...
        patch_errorbar(nanmean(data_around_egg_body_only_x')', nansem(data_around_egg_body_only_x')', time_base_egg', [.5 .5 .5])
    end
...
if(~isempty(data_around_egg_body))
    if(ppp > 1)
        ...
        patch_errorbar(nanmean(data_around_egg_body_only_y')', nansem(data_around_egg_body_only_y')', time_base_egg', [.5 .5 .5])
    end
