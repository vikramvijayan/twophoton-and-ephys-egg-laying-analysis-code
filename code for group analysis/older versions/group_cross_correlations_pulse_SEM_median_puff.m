function [corr_structure,pulse_structure] = group_cross_correlations_pulse_SEM_median_puff(recordings_list, ROI_num, min_power, max_power, filter_out_pulse, backsub, pulse_duration_min,pulse_duration_max)
...
for rec_index = 1:1:length(recordings_list)
    ...
    %recording.movie1.no_egg3 = causal_filter(2500, fliplr(recording.movie1.no_egg3));
    ...
    [time_base_to_return, data_to_average_interp]  = average_around_event(recording.movie1.egglaid,movtime,all_pulset, time_interval);
