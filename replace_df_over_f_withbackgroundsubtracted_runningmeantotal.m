...
function recording = replace_df_over_f_withbackgroundsubtracted_runningmeantotal(recording)
...
for i =1:1:length(recording.tseries)
    for  k =1:1:(recording.tseries(i).ROI_number)
        ...
        interpsignal_sm = smoothdata(interpsignal,'movmean',10*60*30,'omitnan');
